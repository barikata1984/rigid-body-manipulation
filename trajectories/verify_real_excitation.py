...
from dynamics import setup_robot_dynamics_parameters, calculate_frame_dynamics
...
def main():
    ...
    (poses, id_ll, pose_ll_llj, uscrews_lj, simats_lj_l, 
     hposes_lj_kj, inverse_dynamics_func) = setup_robot_dynamics_parameters(m, d)
