...
class ExcitedTrajectory(BaseTrajectory):
    def __init__(
        ...
        self.a = np.random.uniform(-0.01, 0.01, (self.num_joints, num_harmonics))
        self.b = np.random.uniform(-0.01, 0.01, (self.num_joints, num_harmonics))
    ...
    def _optimize(self, max_iter=50):
        print(f"Starting ExcitedTrajectory Optimization...")
    ...
    def generate(self, show_plot: bool = False, plot_path: str | None = None, json_path: str | None = None, max_iter: int = 50):
        """
