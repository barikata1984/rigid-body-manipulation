...
def load_config():
    ...
    except ConfigAttributeError:  # if read_config not provided on cli, cli_cfg does not have it as its attribute, so using this error rather than MissingMandatoryValue
        yaml_cfg = {}
