...
def inverse(
    ...
    hposes_body_parent,
    simats_body: NDArray,
    uscrews_body: NDArray,
    twist_0: NDArray,
    dtwist_0: NDArray,
    wrench_tip: NDArray | None = None,
    pose_tip_ee: NDArray | None = None,
):
    if wrench_tip is None:
        wrench_tip = np.zeros(6)

    if pose_tip_ee is None:
    ...
    return ctrl_mat.sum(axis=1), poses, twists, dtwists  # type: ignore
