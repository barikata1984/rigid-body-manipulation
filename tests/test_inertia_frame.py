...
mjcf_model_1.worldbody.add("body", name="cuboid")  # type: ignore
print(f"{dir(mjcf_model_1.worldbody.body[0].inertial)=}")  # type: ignore
...
print("===============================================")
print("Pattern 1: Set 'diaginertia'")
...
body = mjcf_model_2.worldbody.add("body", name="cuboid")  # type: ignore
mjcf_model_1.worldbody.body[0].add(  # type: ignore
    "inertial",
    pos=[0, 0, 0],
    mass=mass,
    # diaginertia=diaginertia,
